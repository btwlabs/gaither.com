...
<div class="author-pane">
 <div class="author-pane-inner">
    ...
    <div class="author-pane-section author-pane-general">
      ...
      <?php if (!empty($last_active)): ?>
        <div class="author-pane-line">
           <span class="author-pane-label"><?php print t('Last activity'); ?>:</span> <?php print t('!time ago', array('!time' => $last_active)); ?>
        </div>
      <?php endif; ?>
	...
	while ($expiration = db_fetch_array($expirations)) { 
	  if($expiration['rid'] == '4') {
		$fanclub_expiration = date('m.d.Y',$expiration['expiration']);
	  }
	}
	print($fanclub_expiration);
