...
// Add necessary jQuery UI effects for theme
jquery_ui_add(array('ui.core', 'effects.core', 'effects.highlight'));

/* 
// Change Search block submit text (search block now off by default)
